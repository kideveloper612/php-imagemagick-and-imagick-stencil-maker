...
<h2> Step 1:  Upload Image. </h2>
 <br>
  ...
  <?php
  echo "<img src=\"$relativeUploadedFile\" alt=\"uploaded\" style=\"max-height:130px; max-width:180px;\"> ";
  ?>
  </div>
...
-->
 ...
 <font style="display:inline-block; padding: 0px 0px 0px 5px; mmargin:0px 1px 1px 1px;">Contrast:</font>
...
<?php
  // header("Cache-Control: no-cache, must-revalidate"); //HTTP 1.1
  // header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); // Date in the past
  echo "<img src=\"$relativeStencil\" alt=\"uploaded\" style=\"max-height:350px; max-width:350px;\" > ";
?>
...
<script>             
  function reloadForm () {
    ...
    document.getElementById("stencilMaker").submit();
  }
